            ...
            <form method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="mobile" class="form-control" value="<?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 ? '9876543210' : '' ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Password :</label><?php echo isset($error['password']) ? $error['password'] : ''; ?>
                        <input type="password" class="form-control" name="password" value="<?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 ? '12345678' : '' ?>"><br>
                    </div>
