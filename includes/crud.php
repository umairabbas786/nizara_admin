...
define('DOMAIN_URL', 'localhost/fiv'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'biki1626'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_name = "monkeycr_nizara_admin";    // Change as required
