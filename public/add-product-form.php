...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['products']['create'] == 1) {
        ...
        if (!empty($name) && !empty($category_id) && !empty($serve_for) && empty($error['other_images']) && empty($error['image']) && empty($error['cancelable']) && !empty($description) && empty($error['pincode_ids_inc'])) {
            ...
            $sql = "INSERT INTO products (name,tax_id,seller_id,slug,category_id,brand_id,subcategory_id,subbrand_id,image,other_images,description,indicator,manufacturer,made_in,return_status,cancelable_status, till_status,type,pincodes,is_approved,return_days) VALUES('$name','$tax_id','$seller_id','$slug','$category_id','$brand_id','$subcategory_id','$subbrand_id','$upload_image','$other_images','$description','$indicator','$manufacturer','$made_in','$return_status','$cancelable_status','$till_status','$pincode_type','$pincode_ids','$is_approved','$return_days')";
            // echo $sql;
            $db->sql($sql);
                    ...
                    <div class="box-body">
                        ...
                        <div id="packate_div" style="display:none">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="price">MRP (<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i><input type="number" step="any" min='0' class="form-control" name="packate_price[]" id="packate_price" required />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="discounted_price">Discounted Price (incl Taxes)(<?= $settings['currency'] ?>):</label>
                                        <input type="number" step="any" min='0' class="form-control" name="packate_discounted_price[]" id="discounted_price" />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                        <label for="qty">Available Stock:</label> <i class="text-danger asterik">*</i>
                        ...
                        <div id="loose_div" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group loose_div">
                                        <label for="price">MRP (<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i>
                        ...
                        <div class="form-group">
                            <label for="category_id">Brand :</label> <i class="text-danger asterik">*</i><?php echo isset($error['category_id']) ? $error['category_id'] : ''; ?>
                        ...
                        <div class="form-group">
                            <label for="subcategory_id">Sub Brand :</label>
    ...
    $('#add_packate_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
            ...
            '<?php
                ...
                ?>' +
            '</select></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label for="price">MRP(<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i>' +
    ...
    $('#add_loose_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-4"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
            ...
            '<?php
                ...
                ?>' +
            '</select></div></div>' +
            '<div class="col-md-3"><div class="form-group"><label for="price">MRP  (<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i>' +
