                        ...
                        <div id="variations">
                            ...
                            ?>
                                    <div class="row packate_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group packate_div">
                                                <label for="price">MRP (<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i> <input type="number" step="any" min="0" class="form-control" name="packate_price[]" id="packate_price" value='<?= $row['price']; ?>' required />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group packate_div">
                            ...
                            ?>
                                <div id="loose_div" style="display:none;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group loose_div">
                                                <label for="discounted_price">Discounted Price (incl Taxes)</label>
